...
public class CardNumberValidatorTest {
    ...
    @Test
    public void cardNumberIsNullTest() {
        ...
        try {
            ...
            fail("ApplicationException was expected. Card Number field cannot be null");
        }
        catch (ApplicationException e) {
            msg = e.getMessage();
        }
        
        Assert.assertTrue(msg.toLowerCase().contains("missing: card number"));
    }
